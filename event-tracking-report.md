...
- **event-card-clicked**: Fired when a user clicks on an event card to navigate to the event's detail page.

### app\components\ExploreBtn.tsx

- **explore_events_button_clicked**: Fired when a user clicks the 'Explore Events' button to scroll down to the events section of the page.
